...
function initScene() {
  ...
  const jsonURL = "datasets/20200403_covid19-mexico_videonet_search500_nodes487_2020_04_03_videoNet.json";
  ...
  function getTextures(dataProp, dataMin, dataMax) {
    ...
    Graph.nodeThreeObject(node => {
      ...
      const mapOverlay = imgTexture.load("imgs/thumbs-covid19-mx/" + node.id + ".jpg", function (imgTexture) {
