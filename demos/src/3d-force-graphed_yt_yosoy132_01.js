...
function initScene() {
  ...
  const jsonURL = "datasets/20120511-20120710_YoSoy132ORYo-soy-132ORMasDe132ORMas-de-131_u2u_01-nodes-netJSON.json";
  ...
  function getTextures(dataProp, dataMin, dataMax) {
    ...
    Graph.nodeThreeObject(node => {
      ...
      const mapOverlay = imgTexture.load("imgs/thumbs-yosoy132/" + node.id + ".jpg", function (imgTexture) {
