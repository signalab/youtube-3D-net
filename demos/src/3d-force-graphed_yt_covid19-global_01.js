...
function initScene() {
  ...
  const jsonURL = "datasets/20200403_covid19-global_videonet_search432_nodes425_2020_04_03_videoNet.json";
  ...
  function getTextures(dataProp, dataMin, dataMax) {
    ...
    Graph.nodeThreeObject(node => {
      ...
      const mapOverlay = imgTexture.load("imgs/thumbs-covid19-global/" + node.id + ".jpg", function (imgTexture) {
