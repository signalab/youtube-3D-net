...
function initScene() {
  ...
  const jsonURL = "datasets/20200403_coronavirus-global_videonet_search433_nodes425_2020_04_03_videoNet.json";
  ...
  function getTextures(dataProp, dataMin, dataMax) {
    ...
    Graph.nodeThreeObject(node => {
      ...
      const mapOverlay = imgTexture.load("imgs/thumbs-coronavirus-global/" + node.id + ".jpg", function (imgTexture) {
